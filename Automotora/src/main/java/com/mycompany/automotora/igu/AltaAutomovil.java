...
public class AltaAutomovil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel3);
        jLabel3.setBounds(100, 10, 290, 32);
        ...
        btnAgregar.setBounds(300, 360, 140, 50);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        control.agregarAutomovil(modelo, marca, color, matricula, motor, cantidadPuertas, chasis, padron);

        JOptionPane optionPane = new JOptionPane("El automovil se guardo correctamente");
